...
class SignWindow(QWidget):
    ...
    def sign_up(self):
        ...
        #if password or confirmed password is empty, tells user to fill in
        if not password or not confirm:
            QMessageBox.information(self, 'Error', 'The password is empty',
                                    QMessageBox.Yes)
        #if username already detected in database, tells user to choose another                          
